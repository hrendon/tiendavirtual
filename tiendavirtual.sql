...
CREATE TABLE `tb_carrito` (
  `id` int(11) NOT NULL,
  `tb_video_juego_id` int(11) DEFAULT NULL,
...
INSERT INTO `tb_carrito` (`id`, `tb_video_juego_id`, `tb_usuario_id`, `cantidad`, `compra_confirmada`) VALUES
(1, 1, 3, '1', 0),
(2, 2, 3, '1', 0);
...
--
-- Estructura de tabla para la tabla `tb_video_juegos`
--

CREATE TABLE `tb_video_juegos` (
  `id` int(11) NOT NULL,
...
--
-- Indices de la tabla `tb_video_juegos`
--
ALTER TABLE `tb_video_juegos`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `tb_video_juegos`
--
ALTER TABLE `tb_video_juegos`
